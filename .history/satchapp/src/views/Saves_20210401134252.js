...
const Saves = ({ saves }) => {
  const [isVisible, changeVisibility] = useState({ isVisible: false });

  const isNewItemBarVisible = () =>
    changeVisibility((prevState) => ({ isVisible: !prevState.isVisible }));
  ...
  return (
    <UserTemplate pageType="saves">
      <StyledWrapper>
        ...
        <ButtonIcon icon={plusIcon} onClick={isNewItemBarVisible} />
