...
const Home = () => {
  const links = [
    'https://github.com/TeodorWolski',
    'https://www.linkedin.com/in/teodor-wolski-763a7a1a8/',
    'https://www.instagram.com/wolskiteodor/',
  ];
  ...
  return (
    <StyledWrapper>
      <UserTemplate pageType="home">
        ...
        <StyledParagraph>
          SatchApp is made for people who want to save something and watch it later. Using this app
          is easy:
          <ol>
          ...
          <StyledDevParagraph>Reach me on these social medias:</StyledDevParagraph>
        </StyledParagraph>
      </UserTemplate>
    </StyledWrapper>
  );
